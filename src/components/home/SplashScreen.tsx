...
export default function SplashScreen({ onAnimationComplete }: Readonly<{ onAnimationComplete: () => void }>) {
  return (
    <motion.div
      className="absolute left-0 top-0 z-50 flex h-full w-full items-center justify-center bg-white dark:bg-black"
      initial={{ opacity: 1 }}
      animate={{ opacity: 1 }}
      exit={{ opacity: 0 }}
